                  ...
                  <div className="space-y-8 animate-fade-up" style={{ animationDelay: '0.2s' }}>
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-8">
                      ...
                      <div className="space-y-4 text-gray-700">
                        <div>
                          <p className="font-semibold text-gray-900 mb-1">フジタ電業株式会社</p>
                          <p className="text-sm">Fujita Dengyo Co., Ltd.</p>
                        </div>
                        <div className="pt-4 border-t border-gray-200">
                          <p className="text-sm font-semibold text-gray-600 mb-2">本社ビル・本社工場</p>
                          <p className="text-sm">三重県桑名市大字江場字中野790</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-8">
                      ...
                      <div className="space-y-4 text-gray-700">
                        <div className="flex items-start">
                          ...
                          <div>
                            <p className="text-sm font-semibold text-gray-600">営業部TEL</p>
                            <p className="font-semibold">0594-21-6021</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <svg className="w-5 h-5 text-blue-600 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">0594-23-3805</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <svg className="w-5 h-5 text-blue-600 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div>
                            ...
                            <p className="font-semibold break-all">oka@fujita-dengyo.co.jp</p>
                          </div>
                        </div>
                      </div>
                    </div>
