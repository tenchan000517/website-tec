    ...
    <div className="min-h-screen bg-white">
      <header className="bg-[#2563EB] text-white py-12">
        <div className="max-w-4xl mx-auto px-4">
          <Link href="/works/fujita-dengyo/tech" className="text-blue-100 hover:text-white mb-4 inline-block">
            ← 技術一覧に戻る
          </Link>
            ...
            <div className="flex flex-wrap gap-3">
              {tech.relatedTech.map(relatedSlug => {
                ...
                return related ? (
                  <Link
                    key={relatedSlug}
                    href={`/works/fujita-dengyo/tech/${relatedSlug}`}
