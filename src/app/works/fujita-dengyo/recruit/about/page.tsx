/**
 * @work フジタ電業 フジタ電業を知るページ
 * @category 製造業 リクルートサイト 会社紹介
 *
 * === ページ構成 ===
 * @technique ヒーローセクション（工場写真）
 * @technique 数字で見るフジタ電業（統計データカード）
...
export const metadata: Metadata = {
  title: 'フジタ電業を知る | リクルートサイト | フジタ電業株式会社',
  description: 'フジタ電業の会社概要、数字で見る会社データ、福利厚生、施設情報をご紹介します。',
  keywords: ['フジタ電業', '会社概要', '福利厚生', '施設', 'データ', 'リクルート'],
}
      ...
      <main>
        ...
        <section className="relative h-[400px] md:h-[500px] overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold drop-shadow-lg">フジタ電業を知る</h1>
          </div>
        </section>
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                ...
                <div className="bg-white rounded-3xl overflow-hidden shadow-xl">
                  <div className="relative h-64">
                    <Image
                      src="/works/tokai-parts-industry/images/RECRUIT/benefits/kyuka.jpg"
                      alt="休暇制度"
                      fill
                      className="object-cover"
                    />
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3 text-sm text-gray-700">
                      <p>フジタ電業の休暇制度は以下のものがあります。</p>
                      <div>
                        <p className="font-semibold">【年間休日】</p>
                        <p>年間休日数は121日（会社カレンダー）。長期休暇としてはゴールデンウィーク、お盆休み、正月休みの3つがあります。</p>
                      </div>
                      <div>
                ...
                <div className="bg-white rounded-3xl overflow-hidden shadow-xl">
                  <div className="relative h-64">
                    <Image
                      src="/works/tokai-parts-industry/images/RECRUIT/benefits/ikuji.jpg"
                      alt="育児・介護"
                      fill
                      className="object-cover"
                    />
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      href="/works/fujita-dengyo/recruit/about#childcare"
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                ...
                <div className="bg-white rounded-3xl overflow-hidden shadow-xl">
                  <div className="relative h-64">
                    <Image
                      src="/works/tokai-parts-industry/images/RECRUIT/benefits/1.jpg"
                      alt="住宅費用補助"
                      fill
                      className="object-cover"
                    />
                ...
                <div className="bg-white rounded-3xl overflow-hidden shadow-xl">
                  <div className="relative h-64">
                    <Image
                      src="/works/tokai-parts-industry/images/RECRUIT/benefits/ryo.jpg"
                      alt="寮"
                      fill
                      className="object-cover"
                    />
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-4">寮</h3>
                    <p className="text-sm text-gray-700 mb-4">
                ...
                <div className="bg-white rounded-3xl overflow-hidden shadow-xl">
                  <div className="relative h-64">
                    <Image
                      src="/works/tokai-parts-industry/images/RECRUIT/benefits/2.jpg"
                      alt="保養所"
                      fill
                      className="object-cover"
                    />
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-gray-700 mb-3">
                      保養所は、提携している施設をお得な料金で利用することができます。
                    </p>
                    <div className="text-xs text-gray-600 space-y-1">
                      <p className="font-semibold">【提携保養所】</p>
                      <p>詳細については、入社後にご案内いたします。</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-3xl overflow-hidden shadow-xl">
                  <div className="relative h-64">
                    <Image
                      src="/works/tokai-parts-industry/images/RECRUIT/benefits/3.jpg"
                      alt="ジム"
                      fill
                      className="object-cover"
                    />
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-gray-700 mb-3">
                      社員の健康維持・増進のため、スポーツジムの利用補助制度があります。
                    </p>
                    <p className="text-sm text-gray-700">
                      多くの社員が健康管理のために活用しています。
                    </p>
                  </div>
                </div>
              </div>
