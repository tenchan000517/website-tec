...
export const metadata: Metadata = {
  title: 'クロストーク | リクルートサイト | フジタ電業株式会社',
  description: 'フジタ電業の先輩社員によるクロストークをご紹介します。部署を超えた対談で、会社の魅力をお伝えします。',
  keywords: ['フジタ電業', 'クロストーク', '社員対談', '採用', 'リクルート'],
}
  ...
  const crosstalks = [
    {
      ...
      title: '技術部門の先輩・後輩座談会',
      members: [
        { name: 'N.Tさん', dept: '技術課', group: '製品技術グループ', image: '/works/tokai-parts-industry/images/RECRUIT/corsstalk2/1.jpg' },
        { name: 'I.Rさん', dept: '技術課', group: '製品技術グループ', image: '/works/tokai-parts-industry/images/RECRUIT/crosstalk/4.jpg' },
        { name: 'M.Rさん', dept: '技術課', group: '製品技術グループ', image: '/works/tokai-parts-industry/images/RECRUIT/corsstalk2/5.jpg' }
      ]
    },
    {
      id: '02',
      title: '製造部門の上司・部下座談会',
      members: [
        { name: 'H.Sさん', dept: 'いなべ工場', group: 'はずみ一課', image: '/works/tokai-parts-industry/images/RECRUIT/corsstalk2/2.jpg' },
        { name: 'S.Sさん', dept: 'いなべ工場', group: '成形一課', image: '/works/tokai-parts-industry/images/RECRUIT/corsstalk2/5.jpg' }
      ]
    },
  ]
        ...
        <section className="relative h-[500px]">
          <div className="grid grid-cols-2 h-full">
            ...
            <div className="relative overflow-hidden">
              <Image
                src="/works/tokai-parts-industry/images/RECRUIT/crosstalk/1.jpg"
                alt="クロストーク - 技術部門の先輩・後輩座談会"
                fill
            ...
            <div className="relative overflow-hidden">
              <Image
                src="/works/tokai-parts-industry/images/RECRUIT/corsstalk2/1.jpg"
                alt="クロストーク - 製造部門の上司・部下座談会"
                fill
                className="object-cover"
              />
