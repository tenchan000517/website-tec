                  ...
                  <div className="space-y-6 max-w-4xl mx-auto">
                    ...
                    <div className="border-b border-gray-200 pb-4">
                      <div className="grid md:grid-cols-4 gap-4">
                        ...
                        <div className="md:col-span-3 text-gray-700">
                          週休2日制（会社カレンダーに準ずる）<br />
                          春・夏・冬長期連休有り<br />
                          年間休日121日<br />
                          年次有給休暇（初年度10日、次年度以降17日〜20日、2年間繰越し可能、最大60日）<br />
                          <Link href="/works/fujita-dengyo/recruit/about" className="text-[#F97316] hover:underline inline-flex items-center">
                            詳しくはこちら →
                          </Link>
                        </div>
                      </div>
                    ...
                    <div className="border-b border-gray-200 pb-4">
                      <div className="grid md:grid-cols-4 gap-4">
                        ...
                        <div className="md:col-span-3 text-gray-700">
                          ...
                          MBO面談、IT活用研修、外部セミナー参加、資格取得制度<br />
                          <Link href="/works/fujita-dengyo/recruit/about" className="text-[#F97316] hover:underline inline-flex items-center">
                            詳しくはこちら →
                          </Link>
                        </div>
                  ...
                  <div className="space-y-6 max-w-4xl mx-auto">
                    ...
                    <div className="border-b border-gray-200 pb-4">
                      <div className="grid md:grid-cols-4 gap-4">
                        <div className="font-bold text-[#2563EB]">休日・休暇</div>
                        <div className="md:col-span-3 text-gray-700">
                          週休2日制（会社カレンダーに準ずる）、春・夏・冬長期連休有り<br />
                          年間休日121日（2025年度）<br />
