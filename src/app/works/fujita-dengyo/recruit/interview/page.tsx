...
export const metadata: Metadata = {
  title: '先輩インタビュー | リクルートサイト | フジタ電業株式会社',
  description: 'フジタ電業で活躍する先輩社員のインタビューをご紹介します。仕事のやりがいや職場の雰囲気を知ることができます。',
  keywords: ['フジタ電業', '先輩インタビュー', '社員紹介', '採用', 'リクルート'],
}

export default function InterviewListPage() {
  const officeInterviews = [
    { id: '01', name: 'N.Iさん', year: '2019年入社', dept: '経営管理', group: '財務・企画グループ', title: '経験を伴わず、組織開発の知識の開拓も親切に教えてくれました！', color: 'green', image: '/works/tokai-parts-industry/images/RECRUIT/interview/2.jpg' },
    { id: '02', name: 'M.Iさん', year: '2022年入社', dept: '生産管理', group: '安全衛生推進グループ', title: '会社だけでなく、現場とも向き合いながら組織を整理していく仕事に魅力を感じました！', color: 'blue', image: '/works/tokai-parts-industry/images/RECRUIT/interview/3.jpg' },
    { id: '03', name: 'K.Sさん', year: '2019年入社', dept: '技術課', group: 'プレス技術グループ', title: 'お客様と仲良くものづくりに反映していく、職場の住環境を味わおう。実践講義しよう。', color: 'green', image: '/works/tokai-parts-industry/images/RECRUIT/interview/4.jpg' },
  ]

  const technicalInterviews = [
    { id: '05', name: 'K.Mさん', year: '2011年入社', dept: '製造課', group: 'サブ・管理', title: 'チームリーダーとして、人をマネジメントする楽しさを実感しています', color: 'blue', image: '/works/tokai-parts-industry/images/RECRUIT/interview/5.jpg' },
    { id: '06', name: 'K.Nさん', year: '2022年入社', dept: '製造課', group: 'サブ・管理', title: '先輩にアドバイスをいただきながら、日々、自分の成長を実感しています', color: 'green', image: '/works/tokai-parts-industry/images/RECRUIT/interview/6.jpg' },
    { id: '07', name: 'Y.Aさん', year: '2021年入社', dept: '技術課', group: 'プレス技術', title: 'またたまと経験値を上げ！ 新世代ファイルに魅了されこと！', color: 'blue', image: '/works/tokai-parts-industry/images/RECRUIT/interview/7.jpg' },
    { id: '08', name: 'K.Kさん', year: '2016年入社', dept: '技術課', group: '知立技術', title: '「説得を守りなさい！」その他の先輩からの言葉により成長してきました！', color: 'green', image: '/works/tokai-parts-industry/images/RECRUIT/interview/8.jpg' },
    { id: '09', name: 'E.Mさん', year: '2022年入社', dept: '製造課', group: '知立工場', title: '溶接の技術を学びながら、職場全員が気を配ってくれたのでチャレンジ！', color: 'blue', image: '/works/tokai-parts-industry/images/RECRUIT/interview/9.jpg' },
    { id: '10', name: 'S.Tさん', year: '2019年入社', dept: 'いなべ工場', group: '工場管理', title: 'アットホームな雰囲気の中で、神びがに働けるお疲れを', color: 'green', image: '/works/tokai-parts-industry/images/RECRUIT/interview/1.jpg' },
  ]
        ...
        <section className="relative h-[400px] md:h-[500px]">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 h-full">
            ...
            <div className="relative overflow-hidden">
              <Image
                src="/works/tokai-parts-industry/images/RECRUIT/interview/2.jpg"
                alt="先輩社員"
                fill
                className="object-cover"
              />
              <div className="absolute inset-0 bg-[#4ADE80]/40"></div>
            </div>

            {/* 写真2 - 青 */}
            <div className="relative overflow-hidden">
              <Image
                src="/works/tokai-parts-industry/images/RECRUIT/interview/3.jpg"
                alt="先輩社員"
                fill
                className="object-cover"
              />
            ...
            <div className="relative overflow-hidden">
              <Image
                src="/works/tokai-parts-industry/images/RECRUIT/interview/4.jpg"
                alt="先輩社員"
                fill
                className="object-cover"
              />
            ...
            <div className="relative overflow-hidden">
              <Image
                src="/works/tokai-parts-industry/images/RECRUIT/interview/5.jpg"
                alt="先輩社員"
                fill
                className="object-cover"
              />
            ...
            <div className="relative overflow-hidden">
              <Image
                src="/works/tokai-parts-industry/images/RECRUIT/interview/6.jpg"
                alt="先輩社員"
                fill
                className="object-cover"
              />
            ...
            <div className="relative overflow-hidden">
              <Image
                src="/works/tokai-parts-industry/images/RECRUIT/interview/7.jpg"
                alt="先輩社員"
                fill
                className="object-cover"
              />
