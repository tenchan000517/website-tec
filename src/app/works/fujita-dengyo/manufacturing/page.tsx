 ...
 * === コンテンツ・テキスト ===
 * @content フジタ電業の特徴説明
 * @content 設計から製造まで一貫体制の説明
 * @content オリジナル製品開発の説明
 * @content カスタマイズ対応の説明
 * @content テキスト量調整
 * @content 技術情報表現
 * @content 製造プロセス説明
...
export const metadata: Metadata = {
  title: 'ものづくり | フジタ電業株式会社',
  description: 'フジタ電業の製造プロセスと特徴をご紹介します。設計から製造まで一貫体制、オリジナル製品の開発力、お客様のニーズに応じたカスタマイズ対応により、高品質な製品を提供しています。',
  keywords: ['フジタ電業', 'ものづくり', '製造プロセス', '設計製造一貫', '空箱供給装置', '電磁ブレーキ', '品質管理', '自動化'],
}
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        {/* Fujita Dengyo Features Section */}
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 lg:p-16 animate-fade-up">
                <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
                  当社は昭和41年の創業以来、産業機械の自動化・効率化に貢献してまいりました。機械設計用CAD18台、制御設計用CAD 5台、5面加工機、マシニングセンター、NC旋盤など充実した設備を活用し、設計から製造まで一貫した体制で高品質な製品をお届けしています。
                </p>
                <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                  ISO 9001認証取得による品質管理体制のもと、お客様のニーズに応じた最適なソリューションを提供し、「技術革新と品質第一」をモットーに、確かなものづくりを実践しています。
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 lg:order-1 animate-fade-up">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    機械設計用CAD（2D/3D）18台、制御設計用CAD 5台を駆使し、
                  </p>
                  <p>
                    お客様のニーズに応じた最適な装置を設計。
                  </p>
                  <p>
                    充実した工作機械により設計から製造まで一貫した高品質なものづくりを実現しています。
                  </p>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 animate-fade-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed mb-8">
                  <p>
                    空箱供給装置をはじめとするオリジナル製品の開発により、お客様の生産ラインの無人化・効率化を実現しています。
                  </p>
                  <p>
                    長年培ってきた技術力と独自のノウハウにより、特殊電磁ブレーキ、各種専用機など、産業界の自動化に貢献する製品群を提供しています。
                  </p>
                </div>
                <Link
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 lg:order-1 animate-fade-up">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    標準製品から特注品まで、お客様の生産ラインに最適な装置をご提案。
                  </p>
                  <p>
                    設計から製造まで自社一貫体制だからこそ実現できる、柔軟なカスタマイズ対応により、
                  </p>
                  <p>
                    お客様の多様なニーズにお応えしています。
                  </p>
              ...
              <div className="order-1 lg:order-2 animate-fade-up" style={{ animationDelay: '0.2s' }}>
                <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl p-8 shadow-lg">
                  <div className="relative aspect-square">
                    <Image
                      src="/works/tokai-parts-industry/images/manufacturing/3.jpg"
                      alt="カスタマイズ対応 - 多様なニーズに対応"
                      fill
                      className="object-contain"
                    />
                  </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 text-center animate-fade-up hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ISO 9001認証取得による品質管理体制のもと、確かな品質をお届けします。
                  </p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 text-center animate-fade-up hover:shadow-xl transition-shadow" style={{ animationDelay: '0.2s' }}>
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4">柔軟な対応力</h3>
                  <p className="text-gray-600 leading-relaxed">
                    お客様のニーズに迅速に対応し、最適なソリューションを提供します。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <Link href="/works/fujita-dengyo/recruit" className="group">
                <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-lg p-12 text-center text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  ...
                  <p className="text-base mb-4">採用情報</p>
                  <p className="text-sm mb-6">ものづくりに情熱を持って取り組める方を募集しています</p>
              ...
              <Link href="/works/fujita-dengyo/contact" className="group">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg p-12 text-center text-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  ...
                  <p className="text-base mb-4">各種製品、設備に関するお問い合わせ</p>
                  <p className="text-sm mb-6">お気軽にお問い合わせください</p>
