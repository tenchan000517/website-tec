    ...
    sections: [
      {
        questions: [
          ...
          {
            question: '東海部品工業で働く魅力はどこにあると思いますか？',
            answers: [
              {
                speaker: 'N.Tさん',
    ...
    sections: [
      ...
      },
      {
        ...
        questions: [
          ...
          {
            question: 'お2人が感じる東海部品工業で働く魅力を教えてください',
            answers: [
              {
                speaker: 'H.Sさん',
...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${crosstalk?.title || ''} | 東海部品工業株式会社`,
      ...
      <main>
        ...
        <div className="bg-gray-50 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <Link
              href="/works/tokai-parts-industry/recruit/crosstalk"
        ...
        <section className="py-20 bg-gradient-to-b from-blue-100 to-blue-200">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Link
              href={`/works/tokai-parts-industry/recruit/crosstalk/${crosstalk.otherCrosstalk}`}
