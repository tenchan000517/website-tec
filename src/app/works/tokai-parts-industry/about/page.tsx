...
export const metadata: Metadata = {
  title: '会社情報 | 東海部品工業株式会社',
  description: '東海部品工業の企業理念、トップメッセージ、会社概要をご紹介します。「技術と信頼」をモットーに従業員一人一人の声を吸い上げ、お客様に満足していただける確かな製品生産と地域社会との共存を目指しています。',
  keywords: ['東海部品工業', '会社情報', '企業理念', 'トップメッセージ', '製造業', '自動車部品'],
}
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 lg:p-16 animate-fade-up">
                <div className="space-y-8 text-gray-700 leading-relaxed">
                  <p className="text-lg md:text-xl text-center font-medium">
                    「技術と信頼」をモットーに従業員一人一人の声を吸い上げ、
                  </p>
                  <p className="text-lg md:text-xl text-center font-medium">
                    お客様に満足していただける確かな製品生産と地域社会との共存、
                  </p>
                  <p className="text-lg md:text-xl text-center font-medium">
                    豊かな社会づくりに貢献できる企業を目指しております。
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-8 animate-fade-up">
                <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
                  <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
                    東海部品工業は、トヨタ車体グループの中核企業として「技術と信頼」をモットーに、ミニバン・SUV系の車両骨格であるアンダーボデーを中心のたしかな部品製造をおこなっております。
                  </p>

                  <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
                    私たちは、お客様に満足していただける確かな製品生産を追求し続けています。従業員一人一人の声を大切にし、技術力の向上と品質管理の徹底により、業界をリードする企業として成長してまいりました。
                  </p>

                  <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
                    また、地域社会との共存を大切にし、環境保護活動や社会貢献活動にも積極的に取り組んでおります。持続可能な社会の実現に向けて、私たちにできることを一つ一つ実践してまいります。
                  </p>

                  <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                    これからも、技術革新に挑戦し続け、お客様、従業員、地域社会の皆様とともに、豊かな未来を創造してまいります。
                  </p>
                </div>
