...
export default function RecruitHeader() {
  ...
  const navItems = [
    { label: '先輩インタビュー', href: '/works/tokai-parts-industry/recruit/interview' },
    { label: 'クロストーク', href: '/works/tokai-parts-industry/recruit/crosstalk' },
    { label: '東海部品工業を知る', href: '/works/tokai-parts-industry/recruit/about' },
    { label: 'よくある質問', href: '/works/tokai-parts-industry/recruit/faq' },
    { label: 'オフィシャルサイトに戻る', href: '/works/tokai-parts-industry' },
  ]
  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      ...
      <div className="bg-blue-900 text-white text-xs py-1 px-4">
        <span className="font-semibold">トヨタ車体グループ</span>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          {/* ロゴ */}
          <Link href="/works/tokai-parts-industry/recruit" className="flex items-center">
            <div className="text-xl font-bold">
              <span className="text-blue-900">TBK</span>
              <span className="text-sm ml-2 text-gray-700">東海部品工業株式会社</span>
            </div>
          </Link>
